...
/// For parallel/batch downloads, create a new <see cref="YtdlpObsolete"/> instance for each task.
///
...
public sealed class YtdlpObsolete
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="YtdlpObsolete"/> class.
    /// </summary>
    ...
    [Obsolete("This constructor is no longer used and will be removed in a future version.")]
    public YtdlpObsolete(string ytdlpPath = "yt-dlp", ILogger? logger = null)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    /// <exception cref="ArgumentException">Thrown if path is empty.</exception>
    public YtdlpObsolete SetOutputFolder([Required] string outputFolderPath)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    /// <exception cref="ArgumentException">Thrown if path is empty.</exception>
    public YtdlpObsolete SetTempFolder([Required] string tempFolderPath)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    /// <exception cref="ArgumentException">Thrown if path is empty.</exception>
    public YtdlpObsolete SetHomeFolder([Required] string homeFolderPath)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    /// <exception cref="ArgumentException">Thrown if path is empty.</exception>
    public YtdlpObsolete SetFFmpegLocation([Required] string ffmpegFolder)
    {
    ...
    public YtdlpObsolete SetOutputTemplate([Required] string template)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetFormat([Required] string format)
    {
        _format = format;
        return this;
    }
    ...
    public YtdlpObsolete ExtractAudio(string audioFormat)
    {
    ...
    public YtdlpObsolete SetResolution(string resolution)
    {
    ...
    /// </summary>
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete WriteMetadataToJson()
    {
    ...
    /// </summary>
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete ExtractMetadataOnly()
    {
    ...
    /// </summary>
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete EmbedMetadata()
    {
    ...
    /// </summary>
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete EmbedThumbnail()
    {
    ...
    /// </summary>
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete DownloadThumbnails()
    {
    ...
    public YtdlpObsolete DownloadSubtitles(string languages = "all")
    {
    ...
    public YtdlpObsolete DownloadLivestream(bool fromStart = true)
    {
        _commandBuilder.Append(fromStart ? "--live-from-start " : "--no-live-from-start ");
        return this;
    }

    public YtdlpObsolete DownloadLiveStreamRealTime()
    {
        _commandBuilder.Append("--live-from-start --recode-video mp4 ");
        return this;
    }

    public YtdlpObsolete DownloadSections(string timeRanges)
    {
    ...
    public YtdlpObsolete DownloadAudioAndVideoSeparately()
    {
        _commandBuilder.Append("--write-video --write-audio ");
        return this;
    }

    public YtdlpObsolete PostProcessFiles(string operation)
    {
    ...
    public YtdlpObsolete MergePlaylistIntoSingleVideo(string format)
    {
    ...
    public YtdlpObsolete ConcatenateVideos()
    {
        _commandBuilder.Append("--concat-playlist always ");
        return this;
    }

    public YtdlpObsolete ReplaceMetadata(string field, string regex, string replacement)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetKeepTempFiles(bool keep)
    {
        if (keep) _commandBuilder.Append("-k");
        return this;
    }

    public YtdlpObsolete SetDownloadTimeout(string timeout)
    {
    ...
    public YtdlpObsolete SetTimeout(TimeSpan timeout)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetRetries(string retries)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetDownloadRate(string rate)
    {
    ...
    /// </summary>
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SkipDownloaded()
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetAuthentication(string username, string password)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete UseCookies(string cookieFile)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetCustomHeader(string header, string value)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetUserAgent(string userAgent)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete SetReferer(string referer)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete UseProxy(string proxy)
    {
    ...
    /// </summary>
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete DisableAds()
    {
    ...
    public YtdlpObsolete SelectPlaylistItems(string items)
    {
    ...
    /// <returns>The current <see cref="YtdlpObsolete"/> instance for chaining.</returns>
    public YtdlpObsolete LogToFile(string logFile)
    {
    ...
    public YtdlpObsolete WithConcurrentFragments(int count)
    {
    ...
    public YtdlpObsolete RemoveSponsorBlock(params string[] categories)
    {
    ...
    public YtdlpObsolete EmbedSubtitles(string languages = "all", string? convertTo = null)
    {
    ...
    public YtdlpObsolete CookiesFromBrowser(string browser, string? profile = null)
    {
    ...
    public YtdlpObsolete GeoBypassCountry(string countryCode)
    {
    ...
    public YtdlpObsolete AddCustomCommand(string customCommand)
    {
